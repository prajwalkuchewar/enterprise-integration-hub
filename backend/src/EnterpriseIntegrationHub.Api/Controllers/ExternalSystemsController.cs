...
public sealed class ExternalSystemsController : ControllerBase
{
    ...
    private readonly ViewDetailsExternalSystemHandler _viewDetailsHandler;
    ...
    public ExternalSystemsController(
        ...
        ViewDetailsExternalSystemHandler viewDetailsHandler)
    {
    ...
    [HttpGet]
    [ProducesResponseType(typeof(BrowseExternalSystemsResponseModel), StatusCodes.Status200OK)]
